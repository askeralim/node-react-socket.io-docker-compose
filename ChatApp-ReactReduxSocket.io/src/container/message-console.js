...
import { sendChatMessageAction } from '../actions/index';
...
class MessageConsole extends Component {
  ...
  keyDown(component, event){
     if(event.keyCode == 13 && event.shiftKey == false){
       ...
       component.props.dispatch(sendChatMessageAction(event.target.value, fromId, toId, component.props.activeChatRoom.get('type')));
