  ...
  constructor(props){
    ...
    socket.on('userList',(res)=>{
     ...
     socket.on('myDetails',(res)=>{
		   console.dir('SOCKET :::: My Login Details Message',res)
		   dispatch(loginUserAction(res));
	   })
	   socket.on('user',(res)=>{
		   console.dir('SOCKET :::: User Added Message',res)
		   dispatch(newUserAction(res));
	   })
     socket.on('chatroom',(res)=>{
		   console.dir('SOCKET :::: ChatRoom Added Message',res)
		   dispatch(newChatRoomAction(res));
	   })
     socket.on('message',(res)=>{
		   console.dir('SOCKET :::: Message Received Message',res)
