...
export const sendChatMessageAction = (message, fromId, toId, recepientType) => {
  console.log('Sending Message : ', message);
   return (dispatch) => {
     socket.emit('message', {message, fromId, toId, recepientType});
   }
}
...
export const loginToChatServer = (socket, nickName) => {
   return (dispatch) => {
